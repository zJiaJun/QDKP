...
function myClass.Refresh(self, forceResort)
    ...
    elseif self.Sel=="bid" then
      ...
      if QDKP2_BidM_isBidding() then
        QDKP2_Frame2_Bid_Button:SetText("取消竞价")
      else
        QDKP2_Frame2_Bid_Button:SetText("开始竞价")
      end
...
func=function()
  QDKP2GUI_CloseMenus()
  QDKP2_OpenInputBox("输入要快速调整的DKP分值。",
    function(amount)
...
AltMake={text="绑定DKP",func=function()
  if #myClass.SelectedPlayers == 2 then
    ...
    QDKP2_NotifyUser('想要绑定DKP，按住CTRL，先单击小号，\n后单击要绑定的大号然后在大号右键点\n击绑定DKP。')
  end
end
},
ExternalAdd={text="增加编外人员",
func=function()
  QDKP2_NewExternal()
end
},
ExternalRem={text="移除编外人员",
func=function()
  if #myClass.SelectedPlayers>1 then return; end
...
SelectAll={text="全部选择", func=myClass.SelectAll},
SelectNone={text="全部取消",func=myClass.SelectNone},
SelectInvert={text="反选",func=myClass.SelectInvert},
ExternalPost={text="Post External amounts", func=function() QDKP2_PostExternals("GUILD"); end},
RosterUpdate={text="更新名单", func=myClass.Update},
MenuClose={text="关闭菜单", func=QDKP2GUI_CloseMenus},
