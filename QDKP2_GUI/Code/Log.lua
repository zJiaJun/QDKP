...
Report={text="报告日志",menuList=ReportMenu,hasArrow=true},
CollapseAll={text="全部合并", func=myClass.CollapseAll},
ExpandeAll={text="全部展开", func=myClass.ExpandeAll},
LogUpdate={text="上传日志", func=myClass.Refresh},
...
function myClass.WindowMenu(self)
  ...
  table.insert(menu,{text="日志菜单",isTitle=true})
